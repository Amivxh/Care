...
<?php
      ...
      if (isset($_REQUEST['friend_id'])){
          ...
          $hobby_friend = stripslashes($_REQUEST['hobby_friend']);
          $hobby_friend = mysqli_real_escape_string($conn,$hobby_friend); 
          ...
          $query = "INSERT INTO `friend` (friend_id, firstName, lastName, gender_id, image, hobby_friend, age)
           VALUES ('','$firstName', '$lastName', '$gender_id','','$hobby_friend,'$age')";
