<!-- https://www.codexworld.com/add-event-to-google-calendar-using-php/ -->
      ...
      var calendar = $('#calendar').fullCalendar({
        ...
        select: function (start, allDay) {
          ...
          if (title) {
            ...
            $.ajax({
              url: 'add_events.php',
              data: 'event_name=' + titel + '&date_event=' + start, 
              type: "POST",
        ...
        eventClick: function (event) {
          ...
          if (decision) {
            $.ajax({
              ...
              data: "&even_type_id=" + event_type_id,
              success: function (json) {
                $('#calendar').fullCalendar('removeEvents', event_type_id);
                alert("Updated Successfully");
              }
            });
